                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <p>We provide best service to you!</p>
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="assets/img/demo/bitcoin.jpg">
                                            </a>
                                            <span class="blg-date">05-02-2024</span>

                                        </div>
                                        <div class="col-md-8  col-sm-8 col-xs-8  blg-entry">
                                            <h6> <a href="single.html">이우준 먹튀논란 </a></h6> 
                                            <p style="line-height: 17px; padding: 8px 2px;">Gourmet9 사업 확장 진행 중 급 잠수</p>
                                        </div>
                                    </li> 
                                    ...
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="assets/img/demo/teslalogo.jpg">
                                            </a>
                                            <span class="blg-date">28-01-2024</span>

                                        </div>
                                        <div class="col-md-8  col-sm-8 col-xs-8  blg-entry">
                                            <h6> <a href="single.html">Goumet9, 테슬라 협약 </a></h6> 
                                            <p style="line-height: 17px; padding: 8px 2px;">구독자들, 보이스피싱인지 아닌지 의구심 가져</p>
                                        </div>
                                    </li> 
                                    ...
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="assets/img/demo/break.jpg">
                                            </a>
                                            <span class="blg-date">25-01-2024</span>

                                        </div>
                                        <div class="col-md-8  col-sm-8 col-xs-8  blg-entry">
                                            <h6> <a href="single.html">Gourmet9, 사업위기 봉착 </a></h6> 
                                            <p style="line-height: 17px; padding: 8px 2px;">초기 창업임원들 연락두절</p>
                                        </div>
                                    </li> 
